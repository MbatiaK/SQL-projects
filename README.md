**Nairobi Academy SQL Database Project**
...
Data Management (DML): Populated the database with records for 10 students and subjects, performed updates for student relocations, and handled record deletions for cancelled exams.

Advanced Querying:


Filtering: Utilized WHERE clauses with operators such as BETWEEN, IN, and LIKE for precise data retrieval.


Data Transformation: Implemented CASE WHEN logic to dynamically generate student performance levels (Distinction, Merit, Pass) and seniority categories.


Aggregation: Used COUNT functions to summarize student enrollment by class and performance metrics.
